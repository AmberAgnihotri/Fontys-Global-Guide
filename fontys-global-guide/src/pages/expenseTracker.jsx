...
export default function ExpenseTracker() {
    ...
    const formatDate = (date) => {
        if (!date) return 'Never'; // als je wilt, kun je hier ook t("expense.never") voor maken
            ...
            >
                ...
                >
                    ...
                    <div style={{ marginBottom: '20px' }}>
                        ...
                        >
                            {convertLoading ? t("expense.refreshing") : (convertedAmount || '-')} {toCurrency}
                        </div>
                    </div>
                    ...
                    {convertError && (
                        ...
                        >
                            {/* Deze zin kun je ook vertalen als je wilt */}
                            ! Error: {convertError}
                        </div>
                    )}
                    ...
                    {exchangeRate && !convertError && (
                        ...
                        >
                            ...
                            >
                                <strong>{t("expense.exchangeRate")}:</strong> 1 {fromCurrency} = {exchangeRate.toFixed(4)} {toCurrency}
                            </p>
                            <p
                                style={{
                                    margin: '5px 0',
                            ...
                            >
                                {t("expense.lastUpdated")}: {formatDate(lastUpdated)}
                            </p>
                        </div>
                    )}
                    ...
                    >
                        {convertLoading ? t("expense.refreshing") : `↻ ${t("expense.refresh")}`}
                    </button>
                </div>
                ...
                <div style={{ marginBottom: '30px' }}>
                    ...
                    >
                        {t("expense.total")}: €{totalExpenses.toFixed(2)}
                    </p>
                    <div
                        style={{
                            display: 'grid',
                        ...
                        {categories.map(cat => (
                            totalByCategory[cat] > 0 && (
                                ...
                                >
                                    ...
                                    />
                                    <div>
                                        <strong>{categoryLabels[cat]}:</strong> €{totalByCategory[cat].toFixed(2)}
                                    </div>
                                </div>
                            )
                        ))}
                ...
                {/* Expense List */}
                <div>
                    <h2 style={{ fontSize: '18px' }}>{t("expense.list")}</h2>
                    {expenses.length === 0 ? (
